...
export default class Congratulations extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      item: 'MewTwo',
      uri:
        'https://lh3.googleusercontent.com/-FNeWVeNRqTo/AAAAAAAAAAI/AAAAAAAAAA0/qHilVKwlKbI/photo.jpg',
      friendmode: true,
    }
  }
  ...
  textOption() {
    if (this.state.friendmode) {
      console.log('LAAAAAA')
      return <Text style={styles.normalText}>{this.state.item} is now your connection!</Text>
    } else {
      return (
